...
<head runat="server">
    <title></title>
    <link rel="stylesheet" href="SignInStyle.css"  type="text/css" />
</head>
<body background ="bobross background.jpg">
    ...
    <div>
        ...
        <asp:Button class ="Login" style = "position:absolute; left:47%; top:700px" ID="Button1" runat="server" Text="Login" OnClick="Button2_Click"/>
    </form>
</body>
</html>
